      ...
      <div className="container mx-auto section-padding">
        <div className="text-center mb-12">
          ...
          <p className="text-cream/70 max-w-2xl mx-auto text-lg">
            Ready to transform your sustainability vision into reality? Let's
            engineer a cleaner, more resilient future together.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-5 gap-8 mb-12">
          <Link
            to="/renewable-energy"
            className="text-center p-4 rounded-xl border border-teal-light/20 hover:border-secondary/40 transition-colors"
          >
        ...
        <div className="border-t border-teal-light/20 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-6 text-sm text-cream/70">
              <a
                href="mailto:info@fusionloop.org"
