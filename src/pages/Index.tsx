...
import { Sun, Droplets, Recycle, ClipboardCheck, ArrowRight, Zap, Shield, Leaf, Globe, Users, Wrench, Flame } from "lucide-react";
...
{
    num: "04",
    title: "Flare Gas Monetization",
    desc: "Modular waste-to-wealth flare gas recovery converting associated gas into LPG, CNG and on-site power generation under a zero CAPEX model",
    icon: Flame,
    to: "/flare-gas",
  },
  {
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <img
            src={logo}
            alt="FusionLoop Logo"
            className="h-24 w-24 rounded-2xl mx-auto mb-6 object-cover shadow-2xl"
          />
          ...
          <p className="text-lg md:text-xl text-cream/70 max-w-2xl mx-auto mb-10">
            Integrated Solutions for Renewable Energy, Water Management &
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {differences.map((d, i) => (
              <div
                key={i}
                className="bg-card rounded-xl p-8 border border-border hover:border-secondary/40 transition-colors shadow-sm"
              >
